...
short eatoh(char *s)
{
    ...
    {   
        fprintf(stderr, "%s: eatoh: overflow", __FILE__);
        exit(1);
    }
...
unsigned short eatou(char *s)
{
    ...
    {   
        fprintf(stderr, "%s: eatou: overflow", __FILE__);
        exit(1);
    }
...
int eatoi(char *s)
{
    ...
    {   
        fprintf(stderr, "%s: eatoi: overflow", __FILE__);
        exit(1);
    }
...
unsigned int eatop(char *s)
{
    ...
    {   
        fprintf(stderr, "%s: eatop: overflow", __FILE__);
        exit(1);
    }
...
long eatol(char *s)
{
    ...
    if (errno == ERANGE)
    {   
        fprintf(stderr, "%s: eatol: overflow", __FILE__);
        exit(1);
    }
...
unsigned long eatov(char *s)
{
    ...
    if (errno == ERANGE)
    {   
        fprintf(stderr, "%s: eatov: overflow", __FILE__);
        exit(1);
    }
...
float eatof(char *s)
{
    ...
    {   
        fprintf(stderr, "%s: eatof: overflow", __FILE__);
        exit(1);
    }
...
double eatod(char *s)
{
    ...
    {   
        fprintf(stderr, "%s: eatod: overflow", __FILE__);
        exit(1);
    }
