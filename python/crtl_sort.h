...
#ifndef HEADER_crtl_sort
#define HEADER_crtl_sort
 ...
 * @size: size of each element
 *
extern  * In terms of array indexes, the parent of element j;
...
extern 	size_t n;
extern 	const unsigned int lsbit;
