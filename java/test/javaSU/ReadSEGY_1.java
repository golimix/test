...
class ReadSEGY{
        ...
        public static void readSegy(String filename)
                ...
                do{   
                        ...
                        readCjbsegy(fp, hdr);
                        fp.skip(hdr.ns*4);
                        System.out.println("ns="+hdr.sx);
                } while(fp.available()>0);
        }//read file

        static void readCjbsegy(DataInputStream fp, cjbsegy hdr)
                 throws java.io.IOException,
                        NoSuchFieldException,
                        IllegalAccessException{
        ...
        public static void main(String[]args)                 
                ...
                String vel = "v883301.su";

                ReadSEGY.readSegy(vel);
