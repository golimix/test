...
/*
<applet code="Demo_02_Frame_Mouse_event" width=300 height=90>
</applet>
*/
...
class SampleFrame extends Frame
        ...
        public void paint(Graphics g) {
                ...
                g.drawString("1: Mouse at " + movX + ", " + movY, 10, 40);
          }
}
...
// Applet window.
public class Demo_02_Frame_Mouse_event extends Applet
        implements MouseListener, MouseMotionListener {
        ...
        public void paint(Graphics g) {
                g.drawString(msg, mouseX, mouseY);
                g.drawString("2: Mouse at " + movX + ", " + movY, 0, 10);
          }
}
