# -*- coding: utf-8 -*-
%define libxml2_version 2.9.8
Summary: The libxml2, OM jt_sran requirement
Name: libxml2
Version: 2.9.8
Release: 0%{?dist}
License: BSD
Source: ./libxml2-2.9.8.tar.gz
URL: http://10.170.6.66/
BuildRoot: /tmp/rpm-build-libxml2
Prefix: %{_prefix}
...
%prep
%setup -q -n libxml2-%{libxml2_version}
