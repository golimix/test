...
int main()
{
    char mesg[]="Justa string"; /* 将要被打印的字符串 */
    ...
    /*在屏幕的正中打印字符串 mesg*/
    mvprintw(row-2,0,"Thisscreen has %d rowsand%d columns\n",row,col);
    
    printw("Tryresizingyourwindow(ifpossible)andthen run thisprogramagain");
