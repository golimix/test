...
select customer_id from customer as c where c.customer_id = 3 or c.customer_id = 9;
--same as
select c.customer_id from customer as c where c.customer_id = 3 or c.customer_id = 9;
/*
+-------------+
| customer_id |
+-------------+
