...
/*
 *	void logwtmp (const char *ut_line, const char *ut_name, const char [Function]
 *	*ut_host)
 *	The logwtmp function appends an entry to the user accounting log fle, for the current
