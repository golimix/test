...
/*
$ gcc if_indextoname.c 
$ ./a.out 2
interface 2: ens33
$ ./a.out 1
interface 1: lo
$ ./a.out 0
if_nameindex: No such device or address
$ ./a.out 4
...
{   
    if(argc != 2)
    {
        printf("error: Usage: %s [interface index]\n", argv[0]);
        exit(1);
    }
    
    char *if_name  = malloc(256);
    
    if_name = if_indextoname(atoi(argv[1]), if_name);
