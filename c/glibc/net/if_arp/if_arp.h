...
//On some systems, the ARP cache is also manipulated with the ioctl function. Systems that use routing sockets (Chapter 18(See 9.7)) usually use routing sockets instead of ioctl to access the ARP cache. These requests use an arpreq structure, shown in Figure 17.12 and defined by including the <net/if_arp.h> header.
//
