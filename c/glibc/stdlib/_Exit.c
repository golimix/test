 ...
 *	The _exit function is the primitive for causing a process to terminate with status sta
 *	tus. Calling this function does not execute cleanup functions registered with atexit
 *	or on_exit.
 */
