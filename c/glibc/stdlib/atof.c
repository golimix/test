 ...
 *	This function is similar to the strtod function, except that it need not detect overﬂow
 *	and underﬂow errors. The atof function is provided mostly for compatibility with
