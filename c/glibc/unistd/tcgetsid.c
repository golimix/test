 ...
 *	terminal specifed by fldes is the controlling terminal. If the call is successful the
 ...
 *	ENOTTY The calling process does not have a controlling terminal, or the fle is not
