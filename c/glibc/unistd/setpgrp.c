 ...
 *
 *
 *	int setpgid (pid t pid, pid t pgid) [Function]
 ...
 *	This function fails on a system that does not support job control. See Section 27.2
 *	[Job Control is Optional], page 700, for more information.
 ...
 *	EACCES The child process named by pid has executed an exec function since it
 *	was forked.
 *	EINVAL The value of the pgid is not valid.
 ...
 *	int setpgrp (pid t pid, pid t pgid) [Function]
