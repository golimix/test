...
int fegetexceptflag (fexcept t *flagp, int excepts) [Function]
This function stores in the variable pointed to by ﬂagp an implementation-defned
value representing the current setting of the exception ﬂags indicated by excepts.
