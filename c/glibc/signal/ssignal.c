...
/*
sighandler_t ssignal (int signum, sighandler t action) [Function]
The ssignal function does the same thing as signal; it is provided only for compat
ibility with SVID.
...
int main (void)
{
    ssignal (SIGINT, termination_handler);
