...
/*
 *	void * memset (void *block, int c, size t size) [Function]
 *	This function copies the value of c (converted to an unsigned char) into each of the
 *	frst size bytes of the object beginning at block. It returns the value of block.
 *	wchar_t * wmemset (wchar t *block, wchar t wc, size t size) [Function]
 *	This function copies the value of wc into each of the frst size wide characters of the
