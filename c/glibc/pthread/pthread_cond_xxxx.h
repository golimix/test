 ...
 *	that each condition variable should be accompanied by a mutex.These are the functions
 *	that manipulate condition variables:
 *	n pthread_cond_init initializes a condition variable.The first argument is a
 *	pointer to a pthread_cond_t instance.The second argument, a pointer to a condition
 *	variable attribute object, is ignored under GNU/Linux.
 ...
 *	n pthread_cond_wait blocks the calling thread until the condition variable is signaled.
