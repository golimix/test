...
pthread_rwlockattr_t rwlock2attr;
...
int main ()
{
    ...
    pthread_rwlockattr_init(&rwlock2attr);
    pthread_rwlockattr_setpshared(&rwlock2attr, PTHREAD_PROCESS_SHARED);
    pthread_rwlock_init(&rwlock2, &rwlock2attr);
