 ...
 *
 *
 *	-U name Cancel any previous defnition of name, either built in or provided with a ‘-D’
 *	option.
 *	-undef Do not predefne any system-specifc or GCC-specifc macros. The standard pre
 *	defned macros remain defned. See Section 3.7.1 [Standard Predefned Macros],
 *	page 21.
 */
