 ...
 *	defnes ‘f’ to be a weak alias for ‘__f’. In C++, the mangled name for the target
 *	must be used. It is an error if ‘__f’ is not defned in the same translation unit.
...
//INT __attribute__((weak, alias("INT8")));
