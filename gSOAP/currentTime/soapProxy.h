...
{ public:
	...
	virtual	int currentTime(time_t &response) { return this->currentTime(NULL, NULL, response); }
	virtual	int currentTime(const char *endpoint, const char *soap_action, time_t &response);
};
#endif
