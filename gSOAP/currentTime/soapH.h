...
inline struct ns__currentTime * soap_new_req_ns__currentTime(struct soap *soap) { struct ns__currentTime *_p = soap_instantiate_ns__currentTime(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__currentTime(soap, _p); } return _p; }

inline struct ns__currentTime * soap_new_set_ns__currentTime(struct soap *soap) { struct ns__currentTime *_p = soap_instantiate_ns__currentTime(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__currentTime(soap, _p); } return _p; }
...
inline struct ns__currentTimeResponse * soap_new_req_ns__currentTimeResponse(struct soap *soap, time_t response) { struct ns__currentTimeResponse *_p = soap_instantiate_ns__currentTimeResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__currentTimeResponse(soap, _p); _p->response = response; } return _p; }

inline struct ns__currentTimeResponse * soap_new_set_ns__currentTimeResponse(struct soap *soap, time_t response) { struct ns__currentTimeResponse *_p = soap_instantiate_ns__currentTimeResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__currentTimeResponse(soap, _p); _p->response = response; } return _p; }
