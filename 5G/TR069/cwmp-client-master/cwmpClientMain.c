...
{
    int ret = 0 ;
    struct soap soap ;//SOAP是“Simple Object Access Protocol简单对象访问协议”的缩写。
...
/**
 *  主函数
 *  如何使用才能： Services.FAPService.{i}.CellConfig.RAN
 */
int main(int argc, char **argv)
{
    ...
    CwmpConfig_Init() ;	//Cwmp Client data init .加载xml文件到全局变量
    
#ifndef CWMP_TEST
    ClientSendInform() ;	//Cwmp function Init . include Inform send out .发送信息
#else
