...
0000000000400440 <_start>:
  ...
  40045d:	48 c7 c7 45 05 40 00 	mov    $0x400545,%rdi
...
000000000040052d <helloworld>:
  ...
  400535:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
  400539:	bf 00 06 40 00       	mov    $0x400600,%edi
  40053e:	e8 cd fe ff ff       	callq  400410 <puts@plt>
  400543:	c9                   	leaveq 
  400544:	c3                   	retq   

0000000000400545 <main>:
  400545:	55                   	push   %rbp
  400546:	48 89 e5             	mov    %rsp,%rbp
  400549:	48 8b 15 e8 0a 20 00 	mov    0x200ae8(%rip),%rdx        # 601038 <hello>
  400550:	48 8b 05 e1 0a 20 00 	mov    0x200ae1(%rip),%rax        # 601038 <hello>
  400557:	48 89 c7             	mov    %rax,%rdi
  40055a:	b8 00 00 00 00       	mov    $0x0,%eax
  40055f:	ff d2                	callq  *%rdx
  400561:	b8 03 00 00 00       	mov    $0x3,%eax
  400566:	5d                   	pop    %rbp
  400567:	c3                   	retq   
