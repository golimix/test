 ...
 *        $
 */
#ifndef TIMERCFGMSG_H
#define TIMERCFGMSG_H
#include <sbsconfig_common.h>
/*
 * function declarations 
 */
void            init_timerCfgMsg(void);
FindVarMethod   var_timerCfgMsg;
WriteMethod     write_timerCfgMsgPosMode;
WriteMethod     write_timerCfgMsgCloSreCfg;
